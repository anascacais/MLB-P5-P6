...
# local
from features import bvp_features, ecg_features, eda_features, nonlinear_geo_features, resp_features, spectral_features, statistic_features, temporal_features
from biosppy import signals


def get_feat(signal, sig_lab, sampling_rate=1000., windows_len=5, segment=True, save=False):
    ...
    for wind_idx, wind_sig in enumerate(signal):
        ...
        row_feat = [_f[key] for key in _f.keys()]
        # Temporal Features
